...
class ModelTrainerConfig:
    ...
    hyper_paramter_file_path = os.path.join(
        os.getcwd(), "config", "hyperparameters.yml"
    )
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, train_array, test_array):
        try:
            ...
            with open(
                self.model_trainer_config.hyper_paramter_file_path, "r"
            ) as stream:
            ...
            logging.info(
                f"Best model: {best_model_name} with score: {best_model_score} and hyperparameters: {models[best_model_name]['best_hyperparameters']} found and saved"
            )
